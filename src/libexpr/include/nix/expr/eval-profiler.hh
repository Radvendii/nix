...
public:
     ...
     */
    virtual void preFunctionCallHook(EvalState & state, const ValueRef v, std::span<ValueRef> args, const PosIdx pos);
     ...
     * @param pos Function position.
     */
    virtual void postFunctionCallHook(EvalState & state, const ValueRef v, std::span<ValueRef> args, const PosIdx pos);
