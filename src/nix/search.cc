...
#include "search.md"
    ...
    void run(ref<Store> store, ref<InstallableValue> installable) override
    {
        ...
        std::function<void(eval_cache::AttrCursor & cursor, const std::vector<SymbolRef> & attrPath, bool initialRecurse)>
            visit;

        visit = [&](eval_cache::AttrCursor & cursor, const std::vector<SymbolRef> & attrPath, bool initialRecurse) {
